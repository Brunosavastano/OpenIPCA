...
_IN_SCOPE_PATTERNS = [
    ...
    # Covers variacao/variacoes/variar/variaram and the common preterite "variou"
    # ("quanto a cebola variou?"), without matching "varios/vario" or "variavel".
    re.compile(
        ...
        r"reajust\w*|varia(?:cao|coes|r|ram)?|variou)\b"
    ),
